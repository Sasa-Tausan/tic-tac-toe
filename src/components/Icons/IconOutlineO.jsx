...
export function IconOutlineO({ width, height, fill, stroke }) {
  return (
    <svg width={width} height={height} viewBox="0 0 66 66" xmlns="http://www.w3.org/2000/svg">
      <path
